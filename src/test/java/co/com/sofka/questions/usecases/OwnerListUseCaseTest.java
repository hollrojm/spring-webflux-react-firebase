...
class OwnerListUseCaseTest {
    ...
    @Test
    void ownerListTest(){
        var questionDTO = new QuestionDTO("1111aaa","Que tipo de programacion te gusta?","PROGRAMACION","Desarrollo y Programacion","pruebashollman@gmail.com");
        var question = new Question();
        question.setId("1111");
        question.setUserId("1111aaa");
        question.setQuestion("Que tipo de programacion te gusta?");
        question.setType("PROGRAMACION");
        question.setCategory("Desarrollo y Programacion");
